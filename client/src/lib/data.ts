...
export const packages = [
  {
    ...
    features: ["Professional haircut", "Clean up & style", "Expert guidance on care"],
    popular: false,
  },
  {
    ...
    features: ["Haircut & styling", "Hair spa treatment", "Hair wash & conditioning", "Professional advice on maintenance"],
    popular: true,
  },
  {
    name: "Premium Bridal",
    ...
    features: ["Complete bridal makeup", "Hairstyling & setup", "Skin prep & facial", "Trial session included", "Day-of touch-ups"],
    popular: false,
  },
];
